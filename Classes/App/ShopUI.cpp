	...
	: Interface()
{
	...
	m_buyButton->setPosition(cocos2d::Vector2(
	...
	m_buyLabel->setPosition(m_buyButton->getPosition() + cocos2d::Vector2(0, m_buyButton->getContentSize().height));
...
void ShopUI::buyCallback(cocos2d::Ref* widgetRef, cocos2d::ui::TouchEventType input)
{
